...
/// Dedicated thread to ensure that all interactions with the accessibility client interface run free of race 
/// conditions.
@globalActor public actor ElementActor {
    ...
    public static func run<T: Sendable>(
        ...
        body run: @ElementActor () throws -> T
    ) async rethrows -> T {
    ...
    public final class Executor: SerialExecutor, @unchecked Sendable {
        ...
        ///
        /// This object is not Sendable, but it's also never dereferenced from a different thread after being 
        /// constructed.
        ...
        /// Singleton initializer.
        private init() {
            // Use an NSConditionLock as a poor man's barrier to prevent the initializer from 
            // returning before the thread starts and a run loop is assigned.
        ...
        public func enqueue(_ job: consuming ExecutorJob) {
            // I don't think this code is sound, but it is suggested in the custom actor executors 
